...
function GeneralSettings() {
  ...
  const [scanAll, setScanAll] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const setSavingSettings = () => {
    saveSettings();
    setSettingsSaved(true);
    setTimeout(function () {
  ...
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, __('Use this option in case some files are missing from a theme or plugin. It will find all JavaScript, CSS and image files.', 'simple-static')))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalSpacer, {
    margin: 5
