<div class='alignleft'>
	<div class='http-status'><?php _e( '1xx Informational:', Simply_Static::SLUG ); ?> <b><?php echo $this->http_status_codes['1']; ?></b> |
		...
		<?php _e( "<a href='https://en.wikipedia.org/wiki/List_of_HTTP_status_codes'>More info on HTTP status codes</a>", Simply_Static::SLUG ); ?></div>
</div>
