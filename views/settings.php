...
<div class='wrap' id='settingsPage'>
    ...
    <h2 id='sistTabs' class='nav-tab-wrapper'>
        ...
        <a class='nav-tab' id='include-exclude-tab'
           href='#tab-include-exclude'><?php _e( 'Include/Exclude', 'simply-static' ); ?></a>
    ...
    <form id='optionsForm' method='post' action=''>
            ...
            <table class='form-table'>
                ...
                <tr>
                    ...
                    <td class='url-dest-option'>
							<span>
								<input type="radio" name="destination_url_type"
                                       value="absolute" <?php Util::checked_if( $this->destination_url_type === 'absolute' ); ?>>
							</span>
                        <span>
                ...
                <tr>
                    ...
                    <td class='url-dest-option'>
							<span>
								<input type="radio" name="destination_url_type"
                                       value="relative" <?php Util::checked_if( $this->destination_url_type === 'relative' ); ?>>
							</span>
                        <span>
								<p><label><?php _e( "Use relative URLs", 'simply-static' ); ?></label></p>
								<input aria-describedby='relativePathHelpBlock' type='text' id='relativePath'
                                       name='relative_path' placeholder='/'
                                       value='<?php echo trailingslashit( esc_attr( $this->relative_path ) ); ?>'
                                       size='50'/>
                ...
                <tr>
                    ...
                    <td class='url-dest-option'>
							<span>
								<input type="radio" name="destination_url_type"
                                       value="offline" <?php Util::checked_if( $this->destination_url_type === 'offline' ); ?>>
							</span>
                        <span>
                ...
                <tr class='delivery-method local'>
                    ...
                    <td>
                        ...
                        <input aria-describedby='localDirHelpBlock' type='text' id='localDir' name='local_dir'
                               value='<?php echo esc_attr( $this->local_dir ); ?>' class='widefat'/>
                ...
                <tr class='delivery-method simply-cdn'>
                    ...
                    <td>
                        ...
                        <p>
                            <input aria-describedby='securityTokenHelpBlock' type='text' id='sch_token' name='sch_token'
                                   value='<?php echo esc_attr( get_option( 'sch_token' ) ); ?>' class='widefat'/>
                            <span class="button button-secondary"
                                  id="simply-cdn-connect"><?php esc_html_e( 'Connect', 'simply-static' ); ?></span>
                        </p>
                    </td>
                </tr>
				<?php
				if ( is_network_admin() ) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                <label>
                                    <input <?php checked( $this->allow_subsites, 'yes' ); ?> type='radio'
                                                                                             name='allow_subsites'
                                                                                             value="yes"/> Yes
                                </label>
                            </div>
                            <div>
                                <label>
                                    <input <?php checked( $this->allow_subsites, 'no' ); ?> type='radio'
                                                                                            name='allow_subsites'
                                                                                            value="no"/> No
                                </label>
                            </div>
                    ...
                    <td>
                        <p class='submit'>
                            <input class='button button-primary' type='submit' name='save'
                                   value='<?php _e( "Save Changes", 'simply-static' ); ?>'/>
                        </p>
                    </td>
                </tr>
                </tbody>
        ...
        <div id='include-exclude' class='tab-pane'>
            <table class='form-table'>
                ...
                <tr>
                    ...
                    <td>
                        <textarea aria-describedby='additionalUrlsHelpBlock' class='widefat' name='additional_urls'
                                  id='additionalUrls' rows='5'
                                  cols='10'><?php echo esc_textarea( $this->additional_urls ); ?></textarea>
                ...
                <tr>
                    ...
                    <td>
                        <textarea aria-describedby='additionalFilesHelpBlock' class='widefat' name='additional_files'
                                  id='additionalFiles' rows='5'
                                  cols='10'><?php echo esc_textarea( $this->additional_files ); ?></textarea>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div id="excludableUrlRows">
							<?php foreach ( $urls_to_exclude as $index => $url_to_exclude ) : ?>
                                <div class='excludable-url-row' <?php if ( $index === 0 ) {
                                    ...
                                    <input type='text' name='excludable[<?php echo $index; ?>][url]'
                                           value='<?php echo esc_attr( $url_to_exclude['url'] ); ?>' size='40'/>

                                    <label>
                                        <input name='excludable[<?php echo $index; ?>][do_not_save]' value='0'
                                               type='hidden'/>
                                        <input name='excludable[<?php echo $index; ?>][do_not_save]' value='1'
                                               type='checkbox' <?php Util::checked_if( $url_to_exclude['do_not_save'] === '1' ); ?> />
										<?php _e( "Do not save", 'simply-static' ); ?>
                                    </label>

                                    <label>
                                        <input name='excludable[<?php echo $index; ?>][do_not_follow]' value='0'
                                               type='hidden'/>
                                        <input name='excludable[<?php echo $index; ?>][do_not_follow]' value='1'
                                               type='checkbox' <?php Util::checked_if( $url_to_exclude['do_not_follow'] === '1' ); ?> />
										<?php _e( "Do not follow", 'simply-static' ); ?>
                                    </label>

                                    <input class='button remove-excludable-url-row' type='button' name='remove'
                                           value='<?php _e( "Remove", 'simply-static' ); ?>'/>
                                </div>
							<?php endforeach; ?>
                        </div>

                        <div>
                            <input class='button' type='button' name='add_url_to_exclude' id="AddUrlToExclude"
                                   value='<?php _e( "Add URL to Exclude", 'simply-static' ); ?>'/>
                        </div>
                        ...
                        <div id='excludeUrlsHelpBlock' class='help-block'>
                            ...
                            <p><?php _e( "<b>Do not save</b>: do not save a static copy of the page/file", 'simply-static' ); ?>
                                &mdash; <?php _e( "<b>Do not follow</b>: do not use this page to find additional URLs for processing", 'simply-static' ); ?></p>
        ...
        <div id='advanced' class='tab-pane'>
            ...
            <table class='form-table'>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input aria-describedby='tempFilesDirHelpBlock' type='text' id='tempFilesDir'
                               name='temp_files_dir' value='<?php echo esc_attr( $this->temp_files_dir ) ?>'
                               class='widefat'/>
            ...
            <table class='form-table <?php if ( $this->http_basic_auth_digest != null )
				echo 'hide' ?>' id='basicAuthUserPass'>
                <tbody>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type='text' id='basicAuthUsername' name='basic_auth_username'
                               value='' <?php if ( $this->http_basic_auth_digest != null )
							echo 'disabled' ?> />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type='text' id='basicAuthPassword' name='basic_auth_password'
                               value='' <?php if ( $this->http_basic_auth_digest != null )
							echo 'disabled' ?> />
                    </td>
                </tr>
            ...
            <table class='form-table' id='additional-settings'>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="force_replace_url"
                               id="force_replace_url" <?php Util::checked_if( $this->force_replace_url === 'on' ); ?> />
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="checkbox" name="clear_directory_before_export"
                               id="clear_directory_before_export" <?php Util::checked_if( $this->clear_directory_before_export === 'on' ); ?> />
                    </td>
                </tr>
    ...
    <div id='advanced' class='tab-pane'>
        <div style="padding: 0 30px;">
            <h2 class="title"><?php _e( "Reset Settings", 'simply-static' ); ?></h2>
            <table class='form-table' id='additional-settings'>
                <tbody>
                <tr>
                    <th>
                    ...
                    <td>
                        <form id='resetForm' method='post' action=''>
                            ...
                            <input aria-describedby='resetSettingsHelpBlock' id='resetSettings'
                                   class='button button-destroy' type='submit' name='reset_settings'
                                   value='<?php _e( "Reset Plugin Settings", 'simply-static' ); ?>'/>
