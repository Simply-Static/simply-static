...
namespace Simply_Static\Tests\Unit {
	...
	final class BootstrapCompatibilityTest extends UnitTestCase {
		...
		public function test_release_metadata_and_bootstrap_hook_are_aligned(): void {
			...
			self::assertMatchesRegularExpression( '/^ \* Version:\s+3\.8\.13$/m', $bootstrap );
			...
			self::assertMatchesRegularExpression( '/^Stable tag:\s+3\.8\.13$/m', $readme );
			...
			self::assertStringContainsString( '= 3.8.13 =', $readme );
			self::assertSame( '3.8.13', $package['version'] ?? null );
			self::assertSame( '3.8.13', $lock['version'] ?? null );
			self::assertSame( '3.8.13', $lock['packages']['']['version'] ?? null );
		}
